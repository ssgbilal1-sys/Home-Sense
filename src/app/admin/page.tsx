            ...
            <div className="rounded-2xl border border-white/8 bg-white/3 p-6 sm:p-8 max-w-3xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div className="space-y-2">
                  <Label className="text-gray-300 text-sm flex items-center gap-2">
                    <svg className="w-4 h-4 text-pink-400" viewBox="0 0 24 24" fill="currentColor"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/></svg>
                    TikTok Profile URL
                  </Label>
                  <Input value={settingsForm.tiktok || ''}
                    onChange={(e) => setSettingsForm(prev => ({ ...prev, tiktok: e.target.value }))}
                    placeholder="https://tiktok.com/@homesense"
                    className="bg-white/5 border-white/10 text-white placeholder:text-gray-600 focus:border-sky-500" />
                </div>
              ...
              <div className="mt-8 pt-6 border-t border-white/10">
                <h3 className="text-lg font-semibold text-white mb-1">Ad Tracking Pixels</h3>
                <p className="text-xs text-gray-500 mb-4">Add your pixel IDs to track visitors and run targeted ads. Only the ID number is needed — the script code is generated automatically.</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-[11px] text-gray-500 mb-1">Facebook Business Manager → Events Manager → Pixel → Copy ID</p>
                    <Input value={settingsForm.metaPixelId} onChange={(e) => setSettingsForm(prev => ({ ...prev, metaPixelId: e.target.value }))}
                      placeholder="e.g. 1234567890" className="bg-white/5 border-white/10 text-white placeholder:text-gray-600 focus:border-sky-500" />
                  </div>
                  <div className="space-y-2">
                    <Label className="text-gray-300 text-sm flex items-center gap-2">
                      <svg className="w-4 h-4 text-pink-400" viewBox="0 0 24 24" fill="currentColor"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/></svg>
                    ...
                    <p className="text-[11px] text-gray-500 mb-1">TikTok Ads Manager → Assets → Events → Pixel → Copy ID</p>
                    <Input value={settingsForm.tiktokPixelId} onChange={(e) => setSettingsForm(prev => ({ ...prev, tiktokPixelId: e.target.value }))}
                      placeholder="e.g. ABCDE12345" className="bg-white/5 border-white/10 text-white placeholder:text-gray-600 focus:border-sky-500" />
                  </div>
                </div>
              </div>
